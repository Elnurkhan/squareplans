          ...
          <section class="mission-section reveal" style="--i: 7">
            ...
            <div class="mission-grid">
              <p class="mission-text">
                Воплощать идеи в&nbsp;реальность так, чтобы результат<br>
              превзошёл ожидания.
              </p>
              <p class="mission-right mission-text">
                Создаём пространства и&nbsp;образы, которые становятся<br>
                частью жизни наших клиентов
              </p>
            </div>
          </section>
        </div>
