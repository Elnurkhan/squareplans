...
const translations = {
  ...
  'project.level': { Ru: 'Level Москва, 48 м²', En: 'Level Moscow, 48 m²' },
  'project.mosfilm': { Ru: 'Мосфильмовский', En: 'Mosfilmovsky' },
  'project.n100': { Ru: 'Настоящее 100 м²', En: 'Nastoyashee 100 m²' },
  'project.n35': { Ru: 'Настоящее 35 м²', En: 'Nastoyashee 35 m²' },
  'project.mntk': { Ru: 'МНТК', En: 'MNTK' },
  'project.sanremo': { Ru: 'Италия. Сан-Ремо', En: 'Italy. Sanremo' },
  'project.afi.title': { Ru: 'AFI Park', En: 'AFI Park' },
  'project.afi.subtitle': { Ru: 'Москва, 135 м²', En: 'Moscow, 135 m²' },
  'project.level.title': { Ru: 'Level', En: 'Level Moscow' },
  'project.level.subtitle': { Ru: 'Москва, 48 м²', En: '48 m²' },
  'project.mosfilm.title': { Ru: 'Мосфильмовский', En: 'Mosfilmovsky' },
  'project.mosfilm.subtitle': { Ru: 'Москва, 100 м²', En: 'Moscow, 100 m²' },
  'project.n100.title': { Ru: 'Настоящее', En: 'Nastoyashee' },
  'project.n100.subtitle': { Ru: 'Москва, 100 м²', En: 'Moscow, 100 m²' },
  ...
  'project.sanremo.subtitle': { Ru: 'Сан-Ремо, 82 м²', En: 'Sanremo, 82 m²' },
